        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 relative">
          ...
          {steps.map((step, index) => {
            ...
            return (
              <Card 
                key={step.number}
                className="p-8 text-center relative hover:shadow-xl transition-all duration-300 hover:-translate-y-2 bg-[var(--gradient-card)] border-border/50 animate-in fade-in zoom-in"
